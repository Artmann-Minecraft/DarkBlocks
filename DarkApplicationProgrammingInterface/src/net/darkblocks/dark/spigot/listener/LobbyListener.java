...
public abstract class LobbyListener implements Listener
{
	...
	protected LobbyListener(GameController gameController, Location lobbyLocation)
	{
	...
	public void onPlayerInteractEvent(PlayerInteractEvent event)
	{
		...
		if (action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK)
		{
			...
			if (item != null)
			{
				...
				else if (event.getItem() != null && item.getType() == Material.SKULL_ITEM && item.getItemMeta() != null && item.getItemMeta().getDisplayName() != null && item.getItemMeta().getDisplayName().equalsIgnoreCase(Colors.SECONDARY + "Zurück zur Lobby"))
				{
