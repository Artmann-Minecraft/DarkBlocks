	...
	public void execute(CommandSender sender, String[] args)
	{
		if (args.length > 1)
		{
			...
			if (target != null)
			{
				...
				target.disconnect(new TextComponent(TEXT + "Du wurdest vom " + Messages.getInstance().getShortMessage(getClass(), "servername") + IMPORTANT + " Netzwerk" + TEXT + " gekickt.\n" + TEXT + "Grund" + IMPORTANT + ": " + IMPORTANT + grund));
				sender.sendMessage(Messages.getInstance().getShortTextComponent(getClass(), "prefix", TEXT + "Du hast " + IMPORTANT + target.getName() + TEXT + " gekickt"));
				for (ProxiedPlayer players : ProxyServer.getInstance().getPlayers())
				{
					...
					players.sendMessage(Messages.getInstance().getShortTextComponent(getClass(), "prefix", IMPORTANT + target.getName() + TEXT + " wurde von " + IMPORTANT + sender.getName() + TEXT + " gekickt."));
					players.sendMessage(Messages.getInstance().getShortTextComponent(getClass(), "prefix", TEXT + "Grund" + IMPORTANT + ": " + IMPORTANT + grund));
				}
			}
			else
			{
